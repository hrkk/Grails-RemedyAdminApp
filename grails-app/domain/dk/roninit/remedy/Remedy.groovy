...
class Remedy {
    ...
    def beforeInsert() {
        ...
        this.addToLogs(new RemedyLog(statusChangeByName: fullName, status: status, user: user));
        this.setUser(user)
    }
    ...
    def beforeUpdate() {
        ...
        if(user?.profile?.fullName) {
            ...
            def log = new RemedyLog(statusChangeByName: fullName, status: status, remedy: this, user : user)
            this.addToLogs(log);
        }
        this.setUser(user)
    }
