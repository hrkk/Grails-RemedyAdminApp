	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<g:if test="${userInstance?.remedies}">
				<li class="fieldcontain">
					<span id="remedies-label" class="property-label"><g:message code="user.remedies.label" default="Remedies" /></span>
					
						<g:each in="${userInstance.remedies}" var="r">
						<span class="property-value" aria-labelledby="remedies-label"><g:link controller="remedy" action="show" id="${r.id}">${r?.encodeAsHTML()}</g:link></span>
						</g:each>
