...
class gsp_remedyAdminApp_profileedit_gsp extends GroovyPage {
...
invokeTag('eachError','g',33,['bean':(profileInstance),'var':("error")],3)
printHtmlPart(19)
})
invokeTag('hasErrors','g',35,['bean':(profileInstance)],2)
printHtmlPart(1)
createTagBody(2, {->
printHtmlPart(20)
invokeTag('hiddenField','g',37,['name':("version"),'value':(profileInstance?.version)],-1)
printHtmlPart(21)
...
invokeTag('form','g',45,['url':([resource: profileInstance, action: 'update']),'method':("PUT")],2)
printHtmlPart(24)
})
