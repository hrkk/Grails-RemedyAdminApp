...
class gsp_remedyAdminApp_userregister_gsp extends GroovyPage {
...
createTagBody(2, {->
printHtmlPart(19)
invokeTag('render','g',30,['template':("registerForm")],-1)
printHtmlPart(20)
invokeTag('render','g',31,['template':("registerProfileForm")],-1)
printHtmlPart(21)
invokeTag('submitButton','g',35,['name':("create"),'class':("save"),'value':(message(code: 'default.button.create.label', default: 'Create'))],-1)
printHtmlPart(22)
})
invokeTag('form','g',37,['url':([resource:userInstance, action:'save2'])],2)
printHtmlPart(23)
})
...
public static final long LAST_MODIFIED = 1445667402000L
