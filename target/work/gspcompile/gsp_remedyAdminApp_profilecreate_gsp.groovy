...
class gsp_remedyAdminApp_profilecreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',30,['bean':(profileInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',32,['bean':(profileInstance)],2)
printHtmlPart(1)
createTagBody(2, {->
printHtmlPart(19)
...
invokeTag('form','g',41,['url':([resource: profileInstance, action: 'save'])],2)
printHtmlPart(22)
})
